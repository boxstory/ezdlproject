    ...
    (function (factory) {
      ...
      var special = ($.event.special.mousewheel = {
        ...
        settings: {
          ...
          normalizeOffset: true, // calls getBoundingbusinessRect for each event
        },
      });
      ...
      function handler(event) {
        ...
        if (special.settings.normalizeOffset && this.getBoundingbusinessRect) {
          var boundingRect = this.getBoundingbusinessRect();
          offsetX = event.businessX - boundingRect.left;
          offsetY = event.businessY - boundingRect.top;
        }
