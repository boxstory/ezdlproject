    ...
    (s.VERSION = "3.4.1"),
      ...
      (s.prototype.adjustDialog = function () {
        var t =
          ...
          document.documentElement.businessHeight;
        this.$element.css({
      ...
      (s.prototype.checkScrollbar = function () {
        ...
        if (!t) {
          var e = document.documentElement.getBoundingbusinessRect();
          t = e.right - Math.abs(e.left);
        }
        (this.bodyIsOverflowing = document.body.businessWidth < t),
      ...
      (s.prototype.measureScrollbar = function () {
        ...
        var e = t.offsetWidth - t.businessWidth;
